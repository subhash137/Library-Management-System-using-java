	        	...
	        	for(int j=0;j<3;j++) {
		        	...
		        	if(s33.contains(password)) {
		        		...
		        		System.out.println("Successfully Registered");
		        	     ...
		        	     FileWriter f5 = new FileWriter("membership.txt",true);
						 BufferedWriter f444 = new BufferedWriter(f5);
		        	     PrintWriter pw2 = new PrintWriter(f444);
		        	     
		        	     int a = (int)(Math.random()*9000)+1000;
		        	     System.out.println("Your membership id is "+a);
		        	     pw2.println(username+","+a+",");
